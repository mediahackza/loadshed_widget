...
function resample(project, delta2) {
  function resampleLineTo(x06, y06, lambda04, a0, b02, c0, x12, y12, lambda12, a1, b12, c1, depth, stream) {
    ...
    if (d2 > 4 * delta2 && depth--) {
      var a4 = a0 + a1, b = b02 + b12, c6 = c0 + c1, m3 = sqrt2(a4 * a4 + b * b + c6 * c6), phi2 = asin(c6 /= m3), lambda22 = abs3(abs3(c6) - 1) < epsilon6 || abs3(lambda04 - lambda12) < epsilon6 ? (lambda04 + lambda12) / 2 : atan2(b, a4), p = project(lambda22, phi2), x22 = p[0], y22 = p[1], dx2 = x22 - x06, dy2 = y22 - y06, dz = dy * dx2 - dx * dy2;
...
function arc_default() {
  ...
  function arc() {
    ...
    if (!(r1 > epsilon7))
      ...
      var a01 = a0, a11 = a1, a00 = a0, a10 = a1, da0 = da2, da1 = da2, ap = padAngle.apply(this, arguments) / 2, rp = ap > epsilon7 && (padRadius ? +padRadius.apply(this, arguments) : sqrt3(r0 * r0 + r1 * r1)), rc = min3(abs4(r1 - r0) / 2, +cornerRadius.apply(this, arguments)), rc0 = rc, rc1 = rc, t0, t1;
      if (rp > epsilon7) {
      ...
      if (!(da1 > epsilon7))
        ...
        if (rc1 < rc)
          context.arc(t0.cx, t0.cy, rc1, atan22(t0.y01, t0.x01), atan22(t1.y01, t1.x01), !cw);
        else {
      ...
      if (!(r0 > epsilon7) || !(da0 > epsilon7))
        ...
        if (rc0 < rc)
          context.arc(t0.cx, t0.cy, rc0, atan22(t0.y01, t0.x01), atan22(t1.y01, t1.x01), !cw);
        else {
...
function pie_default() {
  var value = identity_default4, sortValues = descending_default, sort2 = null, startAngle = constant_default9(0), endAngle = constant_default9(tau6), padAngle = constant_default9(0);
  function pie(data) {
