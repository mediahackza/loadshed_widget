...
var formatAssertions = (assertions) => {
...
var builtinModules = getDefaultExportFromCjs(_static);
...
var createHash = () => (0, import_node_crypto.createHash)("sha256");
...
var beforeExitEmitter = new import_node_events.EventEmitter();
...
var filterEmpty = (open, close, replace = open, at2 = open.length + 1) => (string) => string || !(string === "" || string === void 0) ? clearBleed(
...
async function watchInternal(configs, emitter) {
  ...
  await loadFsEvents();
  const { Watcher } = await import("./watch-BBXQOKYB.js");
...
rollup/dist/es/shared/node-entry.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-NQ2VVKUC.js.map
